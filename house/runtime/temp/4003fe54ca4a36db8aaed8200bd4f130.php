<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"D:\phpStudy\WWW\test\house\public/../application/broker\view\user\appoint_user_lst.htm";i:1516526323;s:68:"D:\phpStudy\WWW\test\house\application\broker\view\public\header.htm";i:1516764725;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php if($vo['status'] == 4): ?>
                                                           <a href="<?php echo url('share/look_status',['id'=>$vo['id'],'status'=>2]); ?>"  class="btn btn-warning btn-xs" onclick="" >完成带看</a>
                                                           <?php else: ?>
