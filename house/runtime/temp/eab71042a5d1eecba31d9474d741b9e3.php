<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"D:\phpStudy\WWW\test\house\public/../application/index\view\index\subscribe.html";i:1516781832;s:68:"D:\phpStudy\WWW\test\house\application\index\view\public\header.html";i:1516498860;s:68:"D:\phpStudy\WWW\test\house\application\index\view\public\footer.html";i:1516777100;}*/ ?>
...
<div class="main">
    ...
    <div class="main_content">
        <div class="main_left">
            <form action="<?php echo url('index/subscribe_add'); ?>" method="post">
            <ul>
                <li>
                ...
                <li>
                    <span class="main_content_title">预留手机号</span>
                    <span class="main_content_value">
                        <input type="text" name="phone" id="" placeholder="填写手机号" />
                    </span>
                </li>
                <li>
                    <span class="main_content_title">带看时间说明</span>
                   <span class="main_content_value"><input type="text" name="user_desc"  placeholder="请备注带看时间" style="width:70%"/></span>
                </li>
