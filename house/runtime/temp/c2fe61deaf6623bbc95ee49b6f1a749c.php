<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\phpStudy\WWW\test\house\public/../application/cleverest\view\estate\lst.htm";i:1515571189;s:71:"D:\phpStudy\WWW\test\house\application\cleverest\view\public\header.htm";i:1516090447;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
...
<a tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" href="<?php echo url('estate/add'); ?>"> <i class="fa fa-plus"></i> Add</a>
<div class="row">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="editabledatatable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo city_name($vo['city_id']); ?></td>
                                                <td><?php echo $vo['create_time']; ?></td>
                                                <td><a href="<?php echo url('estate/status',['id'=>$vo['id'],'status'=>$vo['status']==1?0:1]); ?>"><?php echo status($vo['status']); ?></a></td>
                                                <td>
                                                    <a href="<?php echo url('estate/edit',['id'=>$vo['id']]); ?>" class="btn btn-info btn-xs"><i class="fa fa-edit"></i>更新</a>
                                                    <a href="<?php echo url('estate/commonDelete',['id'=>$vo['id']]); ?>" class="btn btn-danger btn-xs delete" onclick="" ><i class="fa fa-trash-o"></i>删除</a>
                                                </td>
    ...
    <script>
       ...
       var SCOPE={
        'listorder':"<?php echo url('estate/listorder'); ?>",
        }; 
