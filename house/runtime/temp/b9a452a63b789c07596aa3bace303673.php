<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\test\house\public/../application/location\view\login\index.htm";i:1516090636;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="login-container animated fadeInDown">
        <form action="<?php echo url('login/login'); ?>" method="post">
            <div class="loginbox bg-white">
                ...
                <div class="loginbox-textbox">
                    <input class="form-control" placeholder="验证码输入" name="captcha" type="text">
                </div>
                <div class="loginbox-textbox">
