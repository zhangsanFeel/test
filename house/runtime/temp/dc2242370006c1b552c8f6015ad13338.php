<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"D:\phpStudy\WWW\test\house\public/../application/index\view\second_house\index.html";i:1516324683;s:68:"D:\phpStudy\WWW\test\house\application\index\view\public\header.html";i:1516498860;s:68:"D:\phpStudy\WWW\test\house\application\index\view\public\search.html";i:1516331722;}*/ ?>
        ...
        <div class='page-main'>
                <ul>
                  <?php if(is_array($secondes) || $secondes instanceof \think\Collection || $secondes instanceof \think\Paginator): $i = 0; $__LIST__ = $secondes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li>
                        <a href="<?php echo url('second_house/main',['id'=>$vo['id']]); ?>" class="left main-title"><img src="/test/house/public/uploads/<?php echo img($vo['id']); ?>" alt="" style="width:213px;height:160px"/></a>
