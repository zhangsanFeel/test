<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpStudy\WWW\test\house\public/../application/index\view\rent_house\index.html";i:1516346495;s:68:"D:\phpStudy\WWW\test\house\application\index\view\public\header.html";i:1516498860;}*/ ?>
...
<LINK href="/test/house/public/static/index/style/page.css" rel=stylesheet>
...
<!-- 搜索框 -->
  ...
  <div class="content-search">
            ...
            <span class="content-main">
              ...
              <a href="javascript:Filter('price','500');"  <?php if($fitervalue['price'] == '500'): ?> class="activate" <?php endif; ?>>500元以下</a>
              <a href="javascript:Filter('price','500-1000' );"  <?php if($fitervalue['price'] == '500-1000'): ?> class="activate" <?php endif; ?> >500-1000元</a>
              <a href="javascript:Filter('price','1000-1500' );"<?php if($fitervalue['price'] ==  '1000-1500'): ?> class="activate" <?php endif; ?> >1000-1500元</a>
              <a href="javascript:Filter('price','1500-2500' );"  <?php if($fitervalue['price'] == '1500-2500'): ?> class="activate" <?php endif; ?>>1500-2500元</a>
              <a href="javascript:Filter('price','2500-3500' );" <?php if($fitervalue['price'] == '2500-3500'): ?> class="activate" <?php endif; ?>>2500-3500元</a>
              <a href="javascript:Filter('price','3500-4500' );" <?php if($fitervalue['price'] == '3500-4500'): ?> class="activate" <?php endif; ?>>3500-4500元</a>
              <a href="javascript:Filter('price','4500');"  <?php if($fitervalue['price'] == '4500'): ?> class="activate" <?php endif; ?>>4500元以上</a>
            </span>
            </p>
        ...
        <div class='page-main'>
                <ul>
                  <?php if(is_array($rents) || $rents instanceof \think\Collection || $rents instanceof \think\Paginator): $i = 0; $__LIST__ = $rents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <li>
                        <a href="<?php echo url('rent_house/main',['id'=>$vo['id']]); ?>" class="left main-title"><img src="/test/house/public/uploads/<?php echo img($vo['id'],2); ?>" alt="" style="width:213px;height:160px"/></a>
                        <div class="page-content left">
                              <h3><a href="<?php echo url('rent_house/main',['id'=>$vo['id']]); ?>"><?php echo $vo['title']; ?></a><span class="label-blue">新上</span><span class="label-green">房主自荐</span></h3>
                        ...
                        <div class="page-price right">
                                  <p class="page-Countprice"><span><?php echo floatval($vo['price']); ?></span>元</p>
                        </div>
                        <div class="clear"></div>
                    </li>
                  <?php endforeach; endif; else: echo "" ;endif; ?>  
